...
module.exports.fetchBookPublication = async(userName) => {
    let sql = {
        text : `SELECT * FROM book_publications WHERE created_by = $1 ORDER BY id desc`,
        values : [userName]
    }
    console.log('sql ==>', sql)
...
module.exports.insertBookPublicationData = async(bookPublicationData, bookPublicationfileData, userName) => {
    ...
    let sql = {
        ...
        values : [ authorLastName, bookTitle, edition, publicationPlace, publisherCategory, volumeNumber, publisherName, publicationYear,
            bookUrl, doiBookIdParsed, isbnNo, numberOfNmimsAuthors, nmimsAuthors, nmimsCampusAuthors, nmimsSchoolAuthors, bookPublicationfileData, userName]
    }
...
module.exports.updatedBookPublication = async(bookPublicationId, updatedBookPublicationData, upadteDataFileString, userName) => {
    const { authorLastName, bookTitle, edition, publicationPlace, publisherCategory, volumeNumber, publisherName, publicationYear,
...
module.exports.deleteBookPublicationData = async(bookPublicationId, userName) => {
    let sql = {
