...
module.exports.insertEditedBook = async (
  editedBook,
  editedBookFilesData,
  userName
) => {
...
module.exports.updatedEditedBookPublication = async (
  editedBookId,
  updatedEditedBookPublication,
  ...
  let values = [
    ...
    nmimsSchoolAuthors,
    userName,
    ...(supportingDocumentString ? [supportingDocumentString] : []),
  ];
  let sql = {
    text: queryText,
    values: values,
