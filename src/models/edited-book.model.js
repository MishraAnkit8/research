...
module.exports.insertEditedBook = async(editedBook, filename) => {
    ...
    let sql = {
        text : `INSERT INTO edited_book_publications (author_first_name, author_last_name, book_title, edition, editor_name, chapter_title, publication_place, publisher_category, page_number, publisher_name, 
...
module.exports.updatedEditedBookPublication = async(editedBookId, updatedEditedBookPublication, updatedFile) => {
    ...
    let sql = {
        text : `UPDATE edited_book_publications SET author_first_name = $2, author_last_name = $3, book_title = $4, edition = $5, editor_name = $6, chapter_title = $7, publication_place = $8, publisher_category = $9, page_number = $10, publisher_name = $11, 
