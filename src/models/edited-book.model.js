...
module.exports.updatedEditedBookPublication = async(editedBookId, updatedEditedBookPublication, updatedFile) => {
    ...
    let sql = {
        text : `UPDATE edited_book_publications SET author_first_name = $2, book_title = $3, edition = $4, editor_name = $5, chapter_title = $6, publication_place = $7, publisher_category = $8, page_number = $9, publisher_name = $10, 
