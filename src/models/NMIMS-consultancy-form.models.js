...
module.exports.viewConsultancyApprovalForm = async(nmimsConsultancyFormId, userName) => {
...
module.exports.insertConsultancyApprovalFormData = async(consultancyFormData, userName) => {
...
module.exports.updateApprovalFormData = async(nmimsConsultancyFormId, updatedConsultancyApprovalRecord, userName) => {
