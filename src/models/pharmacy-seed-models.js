...
module.exports.insertPharmacyDetails = async (pharmacySeedGrantDetails, userName) => {
   ...
   const {summaryTitle, summaryProjectTitle, principalInvestigator, coInvestigator, projectDuration, totalCost,
        consumablesAmount, analysisAmount, otherAount, projectTitle, researchStatus, scientificImportance, projectObjectives, detailedMethodology,
        timeLines, budgetConsumableAmount, consumablesJustification, solventsAmount, solventsJustification, chemicalsAmount, chemicalsJustification, biomarkersReferenceAmount, biomarkersReferenceJustifications, hplcAmount, hplcJustification, experimentalAnimalsAmount, experimentalAnimalsJustification, cellLinesAmount, cellLinesJustifications, kitsAnalysisAmount, kitsAnalysisJustifications, evaluationAnalysisAmount, evaluationAnalysisJustification, proposedOutCome, previousProjectExplaination,
        references, investigatorName, investigatorDesignation, investigatorAddress, investigatorEmail, investigatorDateOfBirth,
        projectBackGround, hypothesis} = pharmacySeedGrantDetails
    ...
    let sql = {
        ...
        values : [summaryTitle, summaryProjectTitle, principalInvestigator, coInvestigator, projectDuration, totalCost,
            consumablesAmount, analysisAmount, otherAount, projectTitle, researchStatus, scientificImportance, projectObjectives, detailedMethodology,
            timeLines, budgetConsumableAmount, consumablesJustification, solventsAmount, solventsJustification, chemicalsAmount, chemicalsJustification, biomarkersReferenceAmount, biomarkersReferenceJustifications, hplcAmount, hplcJustification, experimentalAnimalsAmount, experimentalAnimalsJustification, cellLinesAmount, cellLinesJustifications, kitsAnalysisAmount, kitsAnalysisJustifications, evaluationAnalysisAmount, evaluationAnalysisJustification, proposedOutCome, previousProjectExplaination,
            references, investigatorName, investigatorDesignation, investigatorAddress, investigatorEmail, investigatorDateOfBirth,
            projectBackGround, hypothesis, userName]
    }
