...
router.post(
  "/researchSeminar/insert",
  upload.array("seminarDocuments", 5),
  asyncErrorHandler(authMiddleware),
  asyncErrorHandler(researchSeminarController.createResearchSeminar)
);
router.post(
  "/researchSeminar/update",
  upload.array("seminarDocuments", 5),
  asyncErrorHandler(authMiddleware),
  asyncErrorHandler(researchSeminarController.updateResearchSeminar)
);
router.post(
  "/researchSeminar/delete",
  asyncErrorHandler(authMiddleware),
  asyncErrorHandler(researchSeminarController.delResearchSeminar)
);
router.post(
  "/researchSeminar/view",
  asyncErrorHandler(authMiddleware),
  asyncErrorHandler(researchSeminarController.viewResearchSeminar)
);
router.get(
  "/researchSeminar/download/:fileName",
  asyncErrorHandler(downloadFileService.downloadFile)
);
router.get(
  "/researchSeminar/viewing/:fileName",
  asyncErrorHandler(downloadFileService.viewFile)
);
