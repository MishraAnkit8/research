...
module.exports.insertTeachingExecellance = async (req, res, next) => {
  ...
  const teachingExecellanceData =
    await teachingExecellanceService.insertTeachingExecellance(
      teachingExecellance,
      req.files,
      userName
    );
  ...
  const pedagogyInnovationFile =
    teachingExecellanceData.teachingFilesArrayData.pedagogyInnovationFileString;
  const fdpProgramFile =
    teachingExecellanceData.teachingFilesArrayData.fdpProgramFileString;
  const workShopFile =
    teachingExecellanceData.teachingFilesArrayData.workShopFileString;
  const invitingFacultyFile =
    teachingExecellanceData.teachingFilesArrayData.invitingFacultyFileString;
  const programOrientationFile =
    teachingExecellanceData.teachingFilesArrayData.programOrientationFileString;
...
module.exports.updatTeachingData = async (req, res, next) => {
  ...
  const updatedTeachingExecellanceData =
    await teachingExecellanceService.updatedTeachingExecellance(
      teachingId,
      updatedTeachingExecellance,
      req.files,
      userName
  ...
  const pedagogyInnovationFile =
    updatedTeachingExecellanceData.teachingDocumentToBeUpdate
...
module.exports.viewTeachingExecellance = async (req, res, next) => {
  ...
  //   console.log("userName in controller teaching excellance ===>>>>>>", userName);
