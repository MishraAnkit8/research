...
module.exports.deleteJournalArticleSchool = async(req, res, next) => {
    ...
    const deleteSchoolStatus = await journalPaperService.deleteSchoolDetails(req.body, userName);
...
module.exports.deleteJournalArticleCampus = async(req, res, next) => {
    ...
    const deleteCampusStatus = await journalPaperService.deleteCampusDetails(req.body, userName);
...
module.exports.deleteJournalArticleAllAuthors = async(req, res, next) => {
    ...
    res.status(statusCode).send({
        ...
        errorCode : deletePolicyCadreStatus.errorCode ? deletePolicyCadreStatus.errorCode : null
    })
